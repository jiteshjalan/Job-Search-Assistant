  ...
  return (
    <div className="panel-slide">
      ...
      <div className="px-5 py-5 space-y-6">
        ...
        {/* Fit score */}
        <div>
          <p className="text-[10px] font-semibold text-[#333] uppercase tracking-widest mb-3">Fit Score</p>
        ...
        {job.topSignals?.length > 0 && (
          <div>
            <p className="text-[10px] font-semibold text-[#333] uppercase tracking-widest mb-2">Why You Fit</p>
        ...
        {/* Full description */}
        <div>
          <p className="text-[10px] font-semibold text-[#333] uppercase tracking-widest mb-2">Job Description</p>
        ...
        {/* Dimension breakdown */}
        <div>
          <p className="text-[10px] font-semibold text-[#333] uppercase tracking-widest mb-3">Dimensional Breakdown</p>
        ...
        {Object.keys(job.excludedFactors ?? {}).length > 0 && (
          <div className="pt-4 border-t border-white/[0.06]">
            <p className="text-[10px] font-semibold text-[#333] uppercase tracking-widest mb-3">Deliberately Excluded</p>
